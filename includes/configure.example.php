...
error_reporting(E_ALL ^ E_DEPRECATED ^ E_NOTICE);
  ...
  define('HTTP_COOKIE_PATH', '/CCHR/');
  define('HTTPS_COOKIE_PATH', '/CCHR/');
  define('DIR_WS_HTTP_CATALOG', '/CCHR/');
  define('DIR_WS_HTTPS_CATALOG', '/CCHR/');
  ...
  define('DIR_FS_CATALOG', 'C:wamp\www\CCHR/');
